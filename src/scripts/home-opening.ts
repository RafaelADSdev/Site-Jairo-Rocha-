...
if(opening) {
 ...
 const features={
  litoral:{title:'Seu lugar em Pernambuco.',subtitle:'Para viver ou investir.',description:'Da vida urbana ao litoral, encontre imóveis e informações para escolher seu próximo endereço.',image:coastImage('coast-hero',1600),srcset:coastImageSet('coast-hero'),alt:'Fotografia de Porto de Galinhas, com recifes, mar e faixa de areia',label:'Explorar o litoral',href:'/litoral',note:'Fotografia real · Porto de Galinhas',credit:'/litoral#creditos-litoral'},

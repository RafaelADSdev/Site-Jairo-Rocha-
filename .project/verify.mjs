...
await page.goto('http://localhost:4322/');const brandName=await page.locator('header .brand').getAttribute('aria-label');if(!brandName?.includes('40 anos'))throw Error('Brand accessible name');await page.locator('#menu-toggle').click();if(!await page.locator('#main-nav').isVisible())throw Error('Mobile menu');
